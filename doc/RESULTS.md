...
| M5, M7 – M11 | ⏳ next: M5 → M7 → M8 → M9 | | |

| Experiment | Status |
|---|---|
| A: Thomson-like clumps | scan and mapping done; likelihood work (M5, M7, M8) is next |
...
Execution order (plan §15, revision 3): M5 → M7 → M8 → M9 → M10 → M11. M6, M12 and M13 are done.
